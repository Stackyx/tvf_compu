...
public:
	...
	StocksStandardFullPath(ContinuousGenerator* gen, double s0, double mu, double maturity, std::vector<double> dividends, std::vector<double> date_dividends, llong n_steps);
