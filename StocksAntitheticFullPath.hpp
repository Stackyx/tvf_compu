...
public:
	...
	StocksAntitheticFullPath(ContinuousGenerator* gen, double s0, double mu, double maturity, R3R1Function* Transform, std::vector<double> dividends, std::vector<double> date_dividends, llong n_steps);
